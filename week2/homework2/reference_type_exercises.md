...
let arr_3 = [2,3,4]; // write this line
console.assert(arr_1 === arr_2);
...
```js
 let obj_1 = {x:1,y:3}; // write this line
let obj_2 = {x:1,y:3}; // write this line
